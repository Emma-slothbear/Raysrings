...
products[0] = new Product("1", "plastic-ring",                  4.50);
products[1] = new Product("2", "leather-ring",                 15.50);
products[2] = new Product("3", "copper-ring",                  17.50);
products[3] = new Product("4", "bone-ring",                     8.50);
products[4] = new Product("5", "iorn-ring",                    20.50);
products[5] = new Product("6", "gold-ring",                   200.00);
products[6] = new Product("7", "silver-ring",                 800.00);
products[7] = new Product("8", "glass-ring",                  400.00);
products[8] = new Product("9", "diamond-ring",               1000.00);
products[9] = new Product("10", "ruby-ring",                90000.00);
products[10] = new Product("11", "unicon-ring",         500000000.00);
products[11] = new Product("12", "tooth-ring",          900000000.00);
products[12] = new Product("13", "dinosaurs-ring",       10000000.00);
products[13] = new Product("14", "kryponite-ring",      700000000.00);
products[14] = new Product("15", "phoenix-ring",               0.00);
...
// shipping
var shipping_rate = 1.99;           // will not be applied if free_shipping = true
